...
En este cuaderno damos una breve introducción al análisis de datos funcionales en R usando la librería [fda.usc](https://cran.r-project.org/web/packages/fda.usc/fda.usc.pdf) de  *Bande, de la Fuente, Galeano, Nieto-Reyes, y Garcia-Portugues*. Dichos paquetes contienen rutinas para el análisis exploratorio de datos funcionales como profundidades, detección de curvas atípicas, modelos de regresión, clasificación supervisada y análisis funcional de varianzas.
